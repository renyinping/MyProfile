...
function mygradle
{
	...
	myunpack_zip ${UNPACK_DIR} ${DL_FILE} ${DL_URL};
}

# 安装android-sdk
function myandroid_sdk
{
	VERSION=r24.4.1
	...
	myunpack_tgz ${UNPACK_DIR} ${DL_FILE} ${DL_URL};
